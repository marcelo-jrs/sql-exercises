...
SELECT t1.COD_CARRO, t1.VIN, t2.NOME_MODELO, t3.NOME_FABRICANTE, STATUS
FROM TB_CARRO AS t1
...
-- Esta tudo como vendido, näo entendi o porque do exercicio

-- 8 - Para cada loja, mostre: COD_LOJA, NOME_LOJA, CIDADE, ESTADO e a quantidade de vendedores na loja.

SELECT t1.COD_LOJA, t1.NOME_LOJA, t1.CIDADE, t1.ESTADO, COUNT(t2.COD_VENDEDOR)
FROM TB_LOJA AS t1
LEFT JOIN TB_VENDEDOR AS t2
ON t1.COD_LOJA = t2.COD_LOJA
GROUP BY t1.COD_LOJA;
